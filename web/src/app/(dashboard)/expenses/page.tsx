  ...
  return (
    <div className="space-y-6">
      <div className="flex items-start justify-between gap-4 animate-[slideDown_0.6s_cubic-bezier(0.34,1.56,0.64,1)]">
        ...
        <button
          onClick={exportCsv}
          className="rounded-lg border border-blue-600/30 bg-gradient-to-r from-blue-600/10 to-transparent px-4 py-2 text-sm font-medium text-blue-300 hover:border-blue-400/60 hover:bg-blue-600/20 transition-all duration-300 hover:shadow-lg hover:shadow-blue-600/20"
        >
          Export CSV
        </button>
      </div>

      <div className="grid gap-4 rounded-2xl border border-blue-600/30 bg-gradient-to-br from-blue-600/10 to-transparent p-6 sm:grid-cols-5 backdrop-blur-sm">
            ...
            {(
              ...
              <button
                ...
                className={`rounded-lg border px-3 py-1.5 text-xs font-medium transition-all duration-300 ${
                  rangePreset === id
                    ? "border-blue-400/60 bg-gradient-to-r from-blue-600 to-blue-700 text-white shadow-lg shadow-blue-600/30"
        ...
        <div className="sm:col-span-1">
          ...
          <input
            ...
            className="mt-1 w-full rounded-lg border border-blue-600/30 bg-blue-600/10 px-3 py-2 text-sm text-white placeholder-white/40 focus:border-blue-400/60 focus:ring-2 focus:ring-blue-400/30 outline-none transition-all"
      ...
      <div className="rounded-2xl border border-blue-600/30 bg-gradient-to-br from-blue-600/10 to-transparent p-6 backdrop-blur-sm animate-[slideUp_0.6s_cubic-bezier(0.34,1.56,0.64,1)_0.1s_backwards]">
        ...
        <div className="grid gap-3 sm:grid-cols-6">
          <div className="sm:col-span-1">
            ...
            <select
              ...
              className="mt-1 w-full rounded-lg border border-blue-600/30 bg-blue-600/10 px-3 py-2 text-sm text-white focus:border-blue-400/60 focus:ring-2 focus:ring-blue-400/30 outline-none transition-all"
            >
      ...
      {editing ? (
        <div className="fixed inset-0 z-50 grid place-items-center bg-black/60 p-4">
          <div className="w-full max-w-lg rounded-xl border border-white/10 bg-black/80 p-4 backdrop-blur">
